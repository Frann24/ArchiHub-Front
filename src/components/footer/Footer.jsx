...
function Footer() {
  return (
    ...
    lg:px-16
    xl:px-32
    2xl:px-64  bg-gray-900 sm:p-6 dark:bg-gray-900"
    >
      <div class="md:flex md:justify-evenly md:items-center">
        <div class="mb-6 md:mb-0">
          <div className="flex flex-row p-4 text-center text-6xl">
            <div className="font-bold text-white">A</div>
            <div className="font-thin text-gray-300">H</div>
          </div>
        </div>
      ...
      <div class="sm:flex sm:items-center sm:justify-evenly">
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-300 text-opacity-50">
          © 2022{" "}
          <a href="https://flowbite.com/" class="hover:underline">
            ArquiHub™
          </a>
