 ...
 */
  ...
  return (
    <div className="bg-white mx-1 p-2 rounded-md shadow-lg lg:p-4">
      ...
      {succes && 
        <div id="toast-success" className="fixed bottom-0 right-0 z-30 flex items-center p-4 mb-4 w-full max-w-xs text-gray-900 bg-white rounded-lg shadow sm:mr-8" role="alert">
          <div className="inline-flex flex-shrink-0 justify-center items-center w-8 h-8 text-green-500 bg-green-100 rounded-lg ">
              <svg aria-hidden="true" className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path  d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" ></path></svg>
              <span className="sr-only">Check icon</span>
          </div>
          <div className="ml-3 text-sm font-normal">Comment created successfully.</div>
          <button onClick={() => setSucces(false)} type="button" className="ml-auto -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex h-8 w-8 " data-dismiss-target="#toast-success" aria-label="Close">
